...
import { GENERIC_WHATSAPP_MESSAGE, buildWhatsAppUrl, listingWhatsAppMessage, trackWhatsAppLead } from "@/lib/whatsapp";
...
export default function FooterWA() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style={{ paddingTop: "60px", paddingBottom: "60px" }}>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <li key={label} className="flex items-center gap-2">
                  ...
                  {href ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={isWhatsApp ? trackWhatsAppLead : () => trackSchedule()}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {OUR_LISTINGS.map(({ label, message }) => (
