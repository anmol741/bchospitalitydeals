    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: "#050d1a" }}>
        <div className="text-center">
          <p className="text-lg mb-4" style={{ color: "#94a3b8" }}>Post not found.</p>
          <Link href="/admin" style={{ color: "#C9A84C" }}>← Back to Admin</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen px-4 py-10" style={{ background: "#050d1a" }}>
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/admin" className="text-sm font-medium transition-colors hover:opacity-80" style={{ color: "#94a3b8" }}>
            ← Back
          </Link>
        </div>
            ...
            <div className="flex gap-4">
              {(["published", "draft"] as const).map((s) => (
                <label key={s} className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className={`w-4 h-4 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-colors ${form.status === s ? "border-[#C9A84C] bg-[#C9A84C]" : "border-[#C9A84C]/30"}`}>
